...
public class Gmail extends Email {
    ...
    public void receiveMail(Date date, String sender, String message){
    	...
    	Mail receivedMail = new Mail(date, sender, message);
    	if(!inbox.isEmpty() && inbox.size() == this.inboxCapacity) {
    		inbox.sort(new Comparator<Mail>() {
    		...
    		trash.add(inbox.get(inboxCapacity-1));
    		inbox.remove(inboxCapacity-1);
    	}
